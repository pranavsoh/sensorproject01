...
class DataIngestionConfig:
    ...
    def initiate_data_ingestion(self) -> path:
        ...
        logging.info("Entered the initiate_data_ingestion method of DataIngestionConfig class")
        try:
            feature_store_file_path = self.export_data_into_feature_store_file_path()
            logging.info("got the data from mongodb")
            logging.info( "Exited the initiate_data_ingestion method of DataIngestionConfig class" )
